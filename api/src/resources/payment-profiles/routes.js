...
export default function createRouter(log) {
  ...
  // curl -X POST "http://localhost:4000/api/v1/payment_profiles/on_board" -H "accept: application/json" -H "Content-Type: application/json" -d "{\"set_as_default\":true,\"account_uuid\":\"3fa85f64-5717-4562-b3fc-2c963f66afa6\"}"
  ...
  // curl -X DELETE "http://localhost:4000/api/v1/payment_profiles/3fa85f64-5717-4562-b3fc-2c963f66afa6" -H "accept: */*"
